...
class TestRunner:
    ...
    def run_all_tests(self):
        ...
        # Test sequence
        tests = [
            ("test_openrouter_setup.py", "Basic OpenRouter API Setup"),
            ("test_learning_path_openrouter.py", "Learning Path Generator with OpenRouter"),
            ("test_api_openrouter.py", "FastAPI Server Integration")
        ]
